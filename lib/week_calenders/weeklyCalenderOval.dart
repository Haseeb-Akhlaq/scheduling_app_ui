...
import 'package:scheduling_app/week_calenders/day_item_oval.dart';
...
class CalendarTimelineOval extends StatefulWidget {
  ...
  @override
  _CalendarTimelineOvalState createState() => _CalendarTimelineOvalState();
}

class _CalendarTimelineOvalState extends State<CalendarTimelineOval> {
  ...
  @override
  void didUpdateWidget(CalendarTimelineOval oldWidget) {
